      ...
      <?php foreach ($charts as $chart): ?>
        ...
        <div class="chart-container"
          ...
          <div class="chart-actions">
            <a href="edit_chart.php?id=<?php echo $chart['identificador']; ?>">Edit</a>
            <a href="delete_chart.php?id=<?php echo $chart['identificador']; ?>" onclick="return confirm('Are you sure?');">Delete</a>
          </div>
